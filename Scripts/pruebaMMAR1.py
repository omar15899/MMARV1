import sys
sys.path.append("/Users/omarkhalil/VisualStudioLocal/MMARV1")
import pandas as pd
from MMAR import MMAR


if __name__ == "__main__":
	df = pd.read_csv("/Users/omarkhalil/VisualStudioLocal/MMARV1/Scripts/Lockheed.txt", delimiter='\t', header=0)
